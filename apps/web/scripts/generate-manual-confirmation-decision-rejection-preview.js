...
const outputDir = join(sourceDir, "manual-confirmation-decision-rejection-preview");
...
const jsonPath = join(outputDir, "manual-confirmation-decision-rejection-preview.json");
const markdownPath = join(outputDir, "manual-confirmation-decision-rejection-preview.md");
